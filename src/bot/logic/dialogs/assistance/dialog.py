...
from src.bot.logic.dialogs.assistance.action import user_text_handler, start_designer_thread_text_handler
from src.bot.logic.dialogs.assistance.getter import answer_getter
...
conversation_dialog: Dialog = Dialog(assistant_init_window, conversation_window)